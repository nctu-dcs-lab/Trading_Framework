...
class StockCombineTrader(StockMarketSyn):
    def __init__(self, save_dir, train_start, train_end, start_year, end_year, init_balance=1000000):
        super().__init__(save_dir, train_start, train_end, start_year, end_year, init_balance)
        # self.longTrader = MaskablePPO.load(f'trained_model/experiment_20241205_29.zip')
        # self.shortTrader = MaskablePPO.load(f'trained_model/experiment_20241209_30.zip')
    ...
    def setup_spaces(self):
        self.action_space = spaces.Discrete(2) # 0 -> long trader, 1 -> short trader
    ...
    def get_trader(self):
        return self.df.iloc[self.index]["trend"]    
